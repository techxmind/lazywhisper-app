...
const POPOVER_SAFE_HEIGHT = 280; // 256px (max-h-64) + 12px (gap) + 12px (safe margin)
    ...
    <AnimatePresence>
      {activePopoverData && (
        <div
          ...
          style={{
            top: activePopoverData.rect.top > POPOVER_SAFE_HEIGHT
            ...
            transform: activePopoverData.rect.top > POPOVER_SAFE_HEIGHT ? 'translateY(-100%)' : 'none',
          }}
        ...
        >
          <motion.div
            key="whisper-popover"
            initial={{ opacity: 0, scale: 0.95, y: activePopoverData.rect.top > POPOVER_SAFE_HEIGHT ? 5 : -5 }}
          ...
          >
            ...
            {(() => {
              ...
              const isAbove = activePopoverData.rect.top > POPOVER_SAFE_HEIGHT;
              return (
                <div
